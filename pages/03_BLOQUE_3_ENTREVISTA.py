...
with tabs[5]:
    ...
    if CANVAS_OK:
        # Firma directa, copiando la lógica simple del BLOQUE 4 TESTIGO.
        # Sin background_image, sin CSS, sin recuadros artificiales: eso estaba
        # colapsando el canvas y generando franjas/lineas en vez del cuadro de firma.
